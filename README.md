...
```loading_data``` is a more practical example for these transformations. It shows an example on how to load images as input data for your network, transform them into cv::Mat and visualize the train/test set.
